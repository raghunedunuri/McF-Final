...
namespace McKeany
{
    public partial class Cocoa : Form
    {
        ...
        {
            InitializeComponent();
            CocoaCommon.InitConfigData(treeGroups);
        ...
        public void PresentData(UIData uiData, bool bShow = true)
        {
            ...
            if (excelQuery != null)
            {
                excelQuery.StoredProc = "McF_GET_COCOA_DATA_EXCEL";
        ...
        private void btnRun_Click(object sender, EventArgs e)
        {
            ...
            uiData.UpdateUIData(treeGroups, null, dtPickerStartTime.Value.ToShortDateString(), dtPickerEndtime.Value.ToShortDateString(), 
                ...
                ChkMatrixFormat.Checked, cmbRollUp.SelectedItem.ToString(), cmdField.SelectedItem.ToString(), "COCOA", cmbFiscal.SelectedIndex, ChkAutoUpdate.Checked);
            PresentData(uiData);
        }
