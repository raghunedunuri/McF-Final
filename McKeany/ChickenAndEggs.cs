...
namespace McKeany
{
    public partial class ChickenAndEggs : Form
    {
        public ChickenAndEggs()
        {
            InitializeComponent();
            CECommon.InitConfigData(treeGroups);
        ...
        public void PresentData(UIData uiData, bool bShow = true)
        {
            ...
            if (excelQuery != null)
            {
                excelQuery.StoredProc = "McF_GET_CE_DATA_EXCEL";
                excelQuery.Fields = uiData.GetSelectedSymbols();
        ...
        private void btnRun_Click(object sender, EventArgs e)
        {
            ...
            uiData.UpdateUIData(treeGroups, null, dtPickerStartTime.Value.ToShortDateString(), dtPickerEndtime.Value.ToShortDateString(), 
                ...
                ChkMatrixFormat.Checked, cmbRollUp.SelectedItem.ToString(), cmdField.SelectedItem.ToString(), "CE", cmbFiscal.SelectedIndex, ChkAutoUpdate.Checked);
            PresentData(uiData);
        }
