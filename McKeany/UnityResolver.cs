...
namespace McKeany
{
    internal static class UnityResolver
    {
        ...
        public static void Init()
        {
            ...
            _unityContainer.RegisterType<ICommonService, CommonService>();
            ...
            _unityContainer.RegisterType<ICommonRepository, CommonRepository>();
