...
namespace McKeany
{
    public partial class CattleOnFeed : Form
    {
        public CattleOnFeed()
        {
            InitializeComponent();
            CFCommon.InitConfigData(treeGroups);
        ...
        public void PresentData(UIData uiData, bool bShow = true)
        {
            ...
            if (excelQuery != null)
            {
                excelQuery.StoredProc = "McF_GET_CF_DATA_EXCEL";
        ...
        private void btnRun_Click(object sender, EventArgs e)
        {
            ...
            uiData.UpdateUIData(treeGroups, null, dtPickerStartTime.Value.ToShortDateString(), dtPickerEndtime.Value.ToShortDateString(), 
                ...
                cmbRollUp.SelectedItem.ToString(), cmdField.SelectedItem.ToString(), "CF", cmbFiscal.SelectedIndex, ChkAutoUpdate.Checked);
            PresentData(uiData);
        }
