...
namespace McKeany
{
    public partial class WASDEDomestic : Form
    {
        public WASDEDomestic()
        {
            InitializeComponent();
            WASDEDomesticCommon.InitConfigData(treeGroups);
        ...
        public void PresentData(UIData uiData, bool bShow = true)
        {
            ...
            if (excelQuery != null)
            {
                excelQuery.StoredProc = "McF_GET_WASDE_DOMESTIC_DATA_EXCEL";
        ...
        private void btnRun_Click(object sender, EventArgs e)
        {
            ...
            uiData.UpdateUIData(treeGroups, null, dtPickerStartTime.Value.ToShortDateString(), dtPickerEndtime.Value.ToShortDateString(), 
                cmbRange.SelectedIndex,(cmbRollUp.SelectedIndex > 0 & cmdField.SelectedIndex > 0), ChkMatrixFormat.Checked, cmbRollUp.SelectedItem.ToString(), cmdField.SelectedItem.ToString(), "WD",
